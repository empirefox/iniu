...
func TestPosBasePublicUtils(t *testing.T) {
	...
	// id:   1  2  3  4  5  6   7
	//                ^
	Convey("IpBeforeOrAfterAnd", t, func() {
...
func TestExchange(t *testing.T) {
	...
	Convey("Exchange", t, func() {
		Convey("directly", func() {
			...
			e := Xchg{}
			posDb("xchgs").First(&e, 1)
			So(e.Pos, ShouldEqual, 4)

			e = Xchg{}
			posDb("xchgs").First(&e, 3)
...
func ps() (s []int64) {
	db.DB.Table(xchgs).Order("pos desc").Pluck("pos", &s)
	return
}
